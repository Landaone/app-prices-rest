...
INSERT INTO `test`.`PRICES`(BRAND_ID, START_DATE, END_DATE, PRICE_LIST, PRODUCT_ID, PRIORITY, PRICE, CURR)
...
INSERT INTO `test`.`PRICES` (`BRAND_ID`, `START_DATE`, `END_DATE`, `PRICE_LIST`, `PRODUCT_ID`, `PRIORITY`, `PRICE`, `CURR`)
VALUES (1, '2020-06-16 00.00.00', '2020-12-31 23.59.59', 4, 35455, 1, 38.95, 'EUR');