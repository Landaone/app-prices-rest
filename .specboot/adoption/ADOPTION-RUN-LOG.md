...
No checkpoint has been reached yet. `ADOPT-00`'s writes are staged for the operator's own commit
workflow but not committed by this run — `ADOPT-17` is the first designed checkpoint step.
